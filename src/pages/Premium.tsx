...
import { Crown, Check, Mail, BarChart3, Shield, Download } from 'lucide-react';
...
const features = [
  ...
  { icon: Download, title: 'Exportera data', desc: 'Ladda ner dina rapporter som PDF eller CSV' },
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-4 sm:gap-6">
        ...
        <Card className="bg-card border-primary/50 glow-amber relative overflow-hidden">
          ...
          <CardContent className="p-5 sm:p-6">
            ...
            <ul className="space-y-3 mb-6">
              {['Obegränsat antal hönor', 'Avancerad statistik & trender', 'E-postpåminnelser', 'Vädervarningar & tips', 'Prioriterad support', 'Exportera data'].map((f) => (

  ...
  return (
    ...
    <main id="main-content" className="min-h-screen bg-background overflow-x-hidden">
      ...
      >
        <div className="container max-w-4xl mx-auto px-5 sm:px-6">
          ...
          <motion.div {...fadeUp(0.1)} className="mb-10 sm:mb-12 flex justify-center">
            <div className="rounded-[2.5rem] overflow-hidden shadow-xl bg-background max-w-[280px] sm:max-w-[320px]">
              <img
                src={appMockup}
      ...
      <section className="relative z-10 py-20 sm:py-28"
        style={{ background: 'linear-gradient(180deg, hsl(var(--secondary)/0.3) 0%, hsl(var(--secondary)/0.5) 40%, hsl(var(--secondary)/0.3) 100%)' }}
      >

...
import { Egg, ArrowRight, Mail, Lock, User } from 'lucide-react';
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-1/2 relative overflow-hidden">
        <img
          src={heroImage}
          alt="Svensk hönsgård i solnedgång"
        ...
        <div className="w-full max-w-md relative z-10">
          ...
          <div className="flex items-center gap-3 mb-10">
            ...
            <div>
              ...
              <p className="text-xs text-muted-foreground">Premium ägghantering</p>
            </div>
          </div>
          ...
          {authMode === 'welcome' && (
            <div className="animate-fade-in space-y-6">
              <div>
                ...
                <p className="text-muted-foreground">Logga in eller skapa ett nytt konto för att komma igång.</p>
              </div>
